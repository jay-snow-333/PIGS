...
print(f"等待Unity连接在 {server_address} 上的数据...")
# 等待连接
connection, client_address = server_socket.accept()
print(f"来自 {client_address} 的连接建立成功！")
# 等待一段时间，模拟实时数据
time.sleep(0.5)
...
with mp_holistic.Holistic(
    ...
    while True:
        ...
        if results.pose_landmarks:
            ...
            landmark_17 = results.pose_landmarks.landmark[17]  # 身体点19-手
        ...
        message = f"{points_hand}"
        connection.sendall(message.encode())
        print(f"已发送手坐标到Unity: {points_hand}")
